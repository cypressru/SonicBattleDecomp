...
configuration. The current whole-ROM unit is only a bootstrap target and does not count as
decompiled code. It will be replaced by evidence-backed translation-unit boundaries.
