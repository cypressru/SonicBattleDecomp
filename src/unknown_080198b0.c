...
extern u32 FUN_08020978(u32 x, u32 y, u16 tile, u32 attributes);
extern void FUN_08020ecc(u32 first, const u8 *source, u8 *destination, u32 width, u32 height,
                         u8 fill);
extern u32 FUN_08020f64(u16 value);
extern u16 FUN_08020fac(u16 value);
extern void FUN_08021000(u16 *destination, const u16 *source, u16 width, u16 rows, u16 offset);
