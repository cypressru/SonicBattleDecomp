...
extern void FUN_08016684(void);
extern void FUN_08017ed0(void);
extern void FUN_08013214(u8 value);
extern void FUN_08017f6c(void);
extern void FUN_08006ff4(u8 value);
extern void FUN_0800f9c0(void);
extern void FUN_08011c7c(void);
extern void FUN_080175d4(void);
extern void FUN_08017d58(void);
extern void FUN_08017c5c(void);
void FUN_08019ed8(void);
...
extern const s16 gUnknown_08edbe7c[][3];
...
extern const u16 gUnknown_08132734[];
extern const u16 gUnknown_0814be64[];
extern const u8 gUnknown_08132374[];
extern const u8 gUnknown_0811dbb0[];
...
extern void FUN_08024304(struct UnknownListNode *node);
extern void FUN_08023b54(struct UnknownListNode *node);
...
extern const u16 gUnknown_08edc2a4[];
extern const u8 gUnknown_08edc2c8[];
...
extern const u8 gUnknown_08ed89c0[];
extern const u8 gUnknown_08ed8ac4[];
...
void FUN_08019ed8(void) {
    {
        ...
        case 0:
            gUnknown_03003d94 = 10;
            break;
        case 1:
            gUnknown_03003d94 = 11;
            break;
        case 2:
            gUnknown_03003d94 = 12;
            break;
        case 3:
            gUnknown_03003d94 = 14;
            break;
        case 4:
            gUnknown_03003d94 = 15;
            break;
        case 5:
            gUnknown_03003d94 = 13;
            break;
        case 6:
            gUnknown_03003d94 = 17;
            break;
        case 7:
            gUnknown_03003d94 = 16;
            break;
        case 8:
            gUnknown_03003d94 = 18;
            break;
        case 9:
            gUnknown_03003d94 = 21;
            break;
        case 10:
            gUnknown_03003d94 = 22;
            break;
        case 11:
            gUnknown_03003d94 = 20;
            break;
        }
    }

    {
        ...
        if ((u8)(state[125] - 2) <= 1) {
            gUnknown_03001380 = 0;
            if ((u8)(state[21] - 17) <= 1 || (u8)(state[22] - 17) <= 1 ||
                (u8)(state[23] - 17) <= 1) {
                gUnknown_03003d94 = 16;
            } else if (state[21] == 8 || state[22] == 8 || state[23] == 8) {
                gUnknown_03003d94 = 19;
            }
        }
    }
}
...
void FUN_0801a04c(u32 value) {
    ...
    if ((s32)value <= 3) {
        ...
        s16 *baseY;
        const u16 *offsetsY;
        u32 metadataOffset = value * sizeof(struct UnknownEntityData);
        s16 target;

        direction = (u8 *)metadataBase + metadataOffset + 159;
        camera->x = *baseX + offsetsX[*direction];
        baseY = &gUnknown_03001b24;
        offsetsY = gUnknown_0807122a;
        camera->y = *baseY + offsetsY[*direction];

        switch (*direction) {
        case 0:
            if ((gUnknown_03001398[value] & 0x200) == 0) {
                FUN_08018318(camera->x, (s16)(camera->y - (gUnknown_03002100 << 4)));
            }
            target = ((-camera->x >> gUnknown_03001b00[0]) + camera->base + gUnknown_0807121a[0]);
            FUN_080176e4(target);
            break;
        case 1:
            if ((gUnknown_03001398[value] & 0x200) == 0) {
            ...
            target = ((camera->x >> gUnknown_03001b00[0]) + camera->base + gUnknown_0807121a[1]);
            FUN_080176e4(target);
            break;
        case 2:
            if ((gUnknown_03001398[value] & 0x200) == 0) {
                FUN_08018318((s16)(camera->x - (gUnknown_03002100 << 4)), camera->y);
            }
            target = ((camera->y >> gUnknown_03001b00[0]) + camera->base + gUnknown_0807121a[2]);
            FUN_080176e4(target);
            break;
        case 3:
            if ((gUnknown_03001398[value] & 0x200) == 0) {
            ...
            target = ((-camera->y >> gUnknown_03001b00[0]) + camera->base + gUnknown_0807121a[3]);
            FUN_080176e4(target);
            break;
        }
    }

    FUN_08018300((s16)(gUnknown_03002100 + 0x200));
    FUN_080182e4(0x200);
}
...
void FUN_0801c85c(u8 first, u8 second) {
    FUN_080182ac();
    FUN_08016684();
    FUN_08017ed0();
    FUN_08013214(first);
...
void FUN_0801e044(u8 value) {
    ...
    if (type == 0) {
        ...
        if (thresholdValue <= 0x3FFFF) {
            ...
            struct UnknownEntity *dataBase = (struct UnknownEntity *)((u8 *)entities + 4);

            *(const void **)((u8 *)dataBase + entityOffset) = data;
            entity->field14 = 0;
            entity->field16 = metadata->field16;
...
void FUN_0801e0c4(u8 value) {
    ...
    }
    {
        ...
        struct UnknownEntityData *metadata =
            (struct UnknownEntityData *)(metadataOffset + (u32)metadataBase);
        u32 type = metadata->field196;
        struct UnknownEntity *savedEntities = entities;
        struct UnknownEntityData *savedMetadataBase = metadataBase;
    ...
    caseOne: {
        const void *data = gUnknown_08ed8a3c;
    ...
    caseTwo: {
        UnknownCallback callback = (UnknownCallback)((u32)FUN_0801e258 + 1);

        entity->callback = callback;
        {
            const void *data = gUnknown_08ed8a78;
            struct UnknownEntity *dataBase = (struct UnknownEntity *)((u32)savedEntities + 4);
    ...
    defaultCase: {
        const void *data = gUnknown_08ed8a28;
        u32 defaultOffset = index * 24;
        struct UnknownEntity *dataBase = (struct UnknownEntity *)((u32)savedEntities + 4);
        struct UnknownEntity *defaultEntity;
        struct UnknownEntityData *defaultMetadata;
...
void FUN_0801e4f4(u8 value) {
    ...
    u32 type = metadata->field20;
    struct UnknownEntityData *savedMetadataBase = metadataBase;
    struct UnknownEntity *savedEntities;
    u32 savedDoubled;
    ...
    }
    {
        ...
        entityOffset *= 8;
        {
            ...
            u32 timer = entity->field12;

            if (timer > 1) {
                u32 current = entity->field8;
                u32 mask = 0xFF0F;
    ...
    }
    {
        ...
        u32 counter = metadata2->field191;
        u32 limitBase = gUnknown_03001b28;
        u32 quarter = counter >> 2;
        s32 limit = limitBase - quarter;
        ...
        {
            u32 linked = (u8)FUN_0801d068(index);

            if (linked != index) {
                struct UnknownEntityData *coordinateBase = gUnknown_03001c40;
                u32 linkedOffset = linked * 2;
                u32 ownOffset = (scaledBase - index) * 4;
                u32 coordinateOffset = linkedOffset + ownOffset;
                u8 *firstBase = (u8 *)coordinateBase + 54;
                s16 *firstPointer = (s16 *)(coordinateOffset + (u32)firstBase);
                u8 *secondBase = (u8 *)coordinateBase + 62;
                u16 second = *(u16 *)(coordinateOffset + (u32)secondBase);
                u32 biasValue = 0x4FF;

                {
                    u32 bias = biasValue;
                    s32 first = *firstPointer;
...
void FUN_0801e62c(u8 value) {
    ...
    {
        struct UnknownEntityData *metadata = gUnknown_03001c40;
        u32 doubledLinked = linked * 2;
        u32 metadataOffset = index * 252;
        u32 coordinateOffset = doubledLinked + metadataOffset;
        u8 *firstBase = (u8 *)metadata;
        s16 *first;
        u8 *secondBase = (u8 *)metadata;
        s16 *second;
        ...
        second = (s16 *)(coordinateOffset + (u32)secondBase);
        {
            ...
            const u8 *savedLookup = lookup;
            u16 angle = ArcTan2(*first, *second);
            u32 result = savedLookup[angle >> 12];
            u32 zero = 0;
    ...
    }
    {
...

        {
...

            {
                const u8 *lookup = gUnknown_08ed8ad4;
                u16 angle = ArcTan2(*first, *second);
                const u8 *resultPointer = &lookup[angle >> 12];
                u32 current;
                u32 bits;
                u32 result;
...
void FUN_0801e2c8(u32 value) {
    ...
    entity->field13 = zero;
    {
        u16 *table = gUnknown_0807125a;
        u8 *tableIndex = &gUnknown_03003e10;
        u32 predicateArgument = table[*tableIndex];
        u32 result;
...
u32 FUN_0801d288(u8 value) {
    ...
    u8 *typePointer;
    u32 type;
    struct UnknownEntity *finalBase;
    u32 finalOffset;
    struct UnknownEntity *finalEntity;
    u32 truncated;
...
void FUN_0801d8f4(u8 value) {
    ...
    if (active != 0) {
        ...
        u8 *secondBase;
        s16 *secondPointer;
        u32 linkedMetadataOffset;
        struct UnknownEntityData *linkedMetadata;
        u16 type;
        ...
        secondPointer = (s16 *)(fieldOffset + (u32)secondBase);
        second = *secondPointer;
        linkedMetadataOffset = linked * 252;
        linkedMetadata = (struct UnknownEntityData *)(linkedMetadataOffset + (u32)metadataBase);
        type = linkedMetadata->field20;

        if ((u16)(type - 10) <= 5) {
            u32 adjustedFirst = (u32)(u16)first << 16;
            u32 adjustment = 0x04FF0000;
            u32 upperBound;
            u32 shiftedSecond;
            s32 signedSecond;

            adjustedFirst += adjustment;
...

    {
        ...
        if (type == 66) {
            ...
            u32 finalOffset = index * 24;
            struct UnknownEntity *finalEntity =
                (struct UnknownEntity *)(finalOffset + (u32)savedEntities);
            u32 zero = 0;

            finalEntity->field8 = zero;
            type = metadata->field20;
            if (type == 0) {
                finalEntity->callback = FUN_0801d618;
                finalEntity->field15 = FUN_0801d068(index);
            }
        }
    }
}
...
void FUN_0801d9e0(u8 value) {
...

    {
        ...
        callback = (UnknownCallback)((u32)FUN_0801daec + 1);
        entity->callback = callback;
        zero = 0;
        entity->field8 = zero;
    }
    ...
    }
    {
        ...
        zero = 0;
        entity->field13 = zero;
        data = gUnknown_08ed898c;
        dataBase = (struct UnknownEntity *)((u32)entities + 4);
        *(const void **)(offset + (u32)dataBase) = data;
        entity->field14 = zero;
        metadataBase = gUnknown_03001c40;
        metadataOffset = index * 252;
        metadata = (struct UnknownEntityData *)(metadataOffset + (u32)metadataBase);
        entity->field16 = metadata->field16;
    }
}
...
u8 FUN_0801d3ac(u8 value) {
    ...
    u32 entityOffset = index * 24;
    struct UnknownEntity *entity = (struct UnknownEntity *)(entityOffset + (u32)entities);
    u32 linkedOffset = entity->field15;
    struct UnknownEntityData *data = gUnknown_03001c40;
    u32 dataOffset;
    u32 offset;
    u8 *firstBase;
...
void FUN_0803d168(struct UnknownListNode *node) {
    ...
    node->data = FUN_0803cfac;
}

void FUN_0803bc38(struct UnknownListNode *node) {
    if (gUnknown_030052f8 != 0) {
        gUnknown_030052f8--;
    } else {
        FUN_0803b764(gUnknown_030052e0);
        gUnknown_030052e0 = 4;
        node->data = FUN_0803bbc4;
    }
}
...
void FUN_08038918(struct UnknownListNode *node) {
    node->position->x = gUnknown_030052f8 + 120;
    node->position->y = gUnknown_08edcee8[gUnknown_030052e0] - gUnknown_030052f8;
    if (gUnknown_030052f8 != 0) {
        FUN_0801fed8(node->field6, 0);
    }
}

void FUN_0803be04(struct UnknownListNode *node) {
    node->position->x = gUnknown_030052f8 + 120;
    node->position->y =
...
void FUN_0803895c(struct UnknownListNode *node) {
    node->position->field0 = gUnknown_08159fd4;
    node->position->tile = 0;
    node->position->x = 120;
    node->position->y = gUnknown_08edcee8[gUnknown_030052e0];
    node->position->field10 = 0;
    node->position->field11 = 0;
    node->position->field12 = 8;
...
u32 FUN_0801cfc8(u8 value) {
    ...
    struct UnknownEntity *entities = gUnknown_03003db0;
    struct UnknownEntity *entity = (struct UnknownEntity *)((u8 *)entities + offset);
...
void FUN_080242bc(struct UnknownListNode *node) {
    const void *const *row;
    const void *data;
    ...
    data = row[gUnknown_03004dd4];
    FUN_08020b74(0, 0, data, 15, 1);
    node->data = (const void *)((u32)FUN_08024304 + 1);
}

void FUN_08024304(struct UnknownListNode *node) {
    struct UnknownListNode *owner = node;
    struct UnknownAllocation25a98 *allocation = owner->allocation;
    u32 zero;
    u32 fill;
    ...
    if ((gUnknown_030048e0.third & 0x100) != 0) {
        zero = 0;
        fill = zero;
        CpuFastSet(&fill, (void *)0x0600b000, 0x01000700);
        gUnknown_03004dbc->field18 = zero;
        allocation->child40 = FUN_0801f7d0(
            (void (*)(struct UnknownListNode *))((u32)FUN_0802482c + 1), 16, gUnknown_03003e20, 0);
        owner->data = (const void *)((u32)FUN_08023b54 + 1);
        FUN_0801f618(420);
    }
}

void FUN_0802426c(struct UnknownListNode *node) {
    gUnknown_03004dbc->field12 = (s16)gUnknown_03004dbc->field12 / 2;
    FUN_0801fba0(16, -gUnknown_03004dbc->field12 & 0x1ff);
    FUN_0801fba0(20, -gUnknown_03004dbc->field12 & 0x1ff);
...
void FUN_08027a4c(struct UnknownListNode *node) {
    u32 value;
    struct Unknown16ByteRecord *record;
    u8 index;
...
void FUN_08038404(void) {
    FUN_0801fbfc((const u16 *)0x08158674, 16);
    FUN_0801fb60();
    FUN_0801fb94();
    FUN_0801ff30();
    FUN_0801f780();
...
void FUN_08030a8c(struct UnknownListNode *node) {
    ...
    *counter = 0;
    ...
    FUN_0802fb58(*selection);
    *selection = *allocation;
    node->data = (const void *)((u32)FUN_080309c0 + 1);
}

void FUN_08030a30(struct UnknownListNode *node) {
    u8 *counter = &gUnknown_030052f8;
    u8 *selection;
    ...
    *counter = 0;
    ...
    if (gUnknown_030052e8[*selection] == 0) {
        (*selection)++;
    }
    node->data = (const void *)((u32)FUN_080309c0 + 1);
}
...
void FUN_08030e1c(struct UnknownListNode *node) {
    u8 *allocation = node->allocation;
...
void FUN_080387dc(struct UnknownListNode *node) {
    u8 *counter = &gUnknown_030052f8;
    u8 *selection;
...
void FUN_0803a478(struct UnknownListNode *node) {
...
void FUN_0803156c(struct UnknownListNode *node) {
    struct UnknownPosition *position = node->position;

    position->field0 = gUnknown_08132374;
    position->tile = gUnknown_08edc2a4[position->field13];
    node->position->x = 256;
    node->position->y = 32;
    node->position->field10 = 0;
    node->position->field11 = 0;
    node->position->field12 = gUnknown_08edc2c8[node->position->field13] << 4;
    node->data = (const void *)((u32)FUN_08031540 + 1);
}
...
void FUN_0802c800(struct UnknownListNode *node) {
    struct UnknownPosition *position = node->position;

    position->field0 = gUnknown_0811dbb0;
    position->tile = 0;
    {
        struct UnknownPosition *position = node->position;

        position->x =
            gUnknown_08edbc1c[position->field13][0] + gUnknown_03005270[position->field13];
    }
    node->position->y = gUnknown_08edbc1c[node->position->field13][1];
    node->position->field10 = 0;
    node->position->field11 = 0;
    node->position->field12 = 0;
    node->data = (const void *)((u32)FUN_0802c85c + 1);
}
...
void FUN_080359d8(struct UnknownListNode *node) {
    struct UnknownListNode *current = node;
    struct UnknownMovementState359d8 *state = current->allocation;
...
void FUN_08031164(void) {
    ...
    FUN_0801fbfc((const u16 *)0x08130324, 16);
    FUN_0801fb94();
    FUN_0801ff30();
    FUN_0801f780();
    FUN_080210d8();
...
void FUN_08033b60(struct UnknownListNode *node) {
    u8 pending = FUN_08020500((u16 *)0x05000000, gUnknown_08132734, 16) == 0;
    u8 result;

    result = FUN_08020500((u16 *)0x05000200, gUnknown_0814be64, 32);
    pending |= result == 0;
    if (pending == 0) {
        node->data = (const void *)((u32)FUN_08033bb4 + 1);
    }
}
...
void FUN_0802dbb4(struct UnknownListNode *node) {
    s8 *allocation = node->allocation;
    const s16 *targets = gUnknown_08edbe7c[node->position->field13];

    allocation[21] = FUN_0801f914(*targets++, allocation[21]);
    allocation[29] = FUN_0801f914(*targets++, allocation[29]);
    allocation[37] = FUN_0801f914(*targets, allocation[37]);
    FUN_0801fed8(node->field6, 0);
}
...
void FUN_08033c74(struct UnknownListNode *node) {
    u8 pending = FUN_08020500((u16 *)0x05000000, gUnknown_08132734, 16) == 0;
    u8 result;
    ...
    pending |= result == 0;
    if (pending == 0) {
        node->data = (const void *)((u32)FUN_08033cc8 + 1);
    }
}
